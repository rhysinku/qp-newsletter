  ...
  return (
    <>
      ...
      <SelectControl
        ...
        options={options}
        onChange={newValue =>
          setSuffixedAttributes(setAttributes, { buttonType: newValue }, suffix)
        }
      ...
      {buttonType == "mod--variant--arrow-only" && !hideUrlInput && (
        <>
          <URLInput
            value={buttonUrl}
            onChange={(url, post) =>
              setSuffixedAttributes(setAttributes, { buttonUrl: url }, suffix)
            }
          />
          <ToggleControl
      ...
      <ToggleControl
        label="Trigger Newsletter Form Popup"
        checked={enableNewsletterType}
        onChange={() =>
          setSuffixedAttributes(
            setAttributes,
            {
              enableNewsletterType: !enableNewsletterType,
            },
            suffix
          )
        }
